        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-lg bg-[#219990] flex items-center justify-center font-bold text-white shadow-xs">
                <Database className="w-4 h-4" />
              </div>
              <div>
                <h1 className="text-sm sm:text-base font-bold leading-none">
                  Chicai Admin Dashboard & Catalog Management
                </h1>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-[#219990] hover:bg-[#1b7e76] text-white text-xs font-bold rounded-xl shadow-md transition cursor-pointer"
            >
              {isFormOpen ? (
                <>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="pl-8 pr-3 py-1.5 text-xs border border-gray-200 rounded-xl outline-hidden focus:border-[#219990] w-48 sm:w-60"
                  />
                </div>
                ...
                <button
                  ...
                  className="px-3 py-1.5 text-xs font-semibold text-gray-700 bg-slate-100 hover:bg-slate-200 rounded-xl transition cursor-pointer"
                >
                  รีเฟรช
                </button>
              </div>
